...
* or from it (flag = -1) */
struct geomvector changesystem(struct geomvector V, struct coordsystem new_syst,
                               int flag);
...
void find_compl(struct atom *atoms1, unsigned int *list_P, unsigned int *list_C1, unsigned int *list_OP1, unsigned int *list_OP2, struct atom *atoms1_P, unsigned int n_P, unsigned int *compl0, unsigned int *first_chain_length);
...
unsigned int run_find_compl(struct atom *atoms1_P, unsigned int n_P, unsigned int *compl0, unsigned int *first_chain_length, int *compl_pair);
